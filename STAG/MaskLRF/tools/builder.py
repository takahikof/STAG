...
def dataset_builder(args, config):
    ...
    if args.distributed:
        ...
        dataloader = torch.utils.data.DataLoader(dataset, batch_size=config.others.bs,
                                                ...
                                                num_workers = int(args.num_workers),
                                                worker_init_fn=worker_init_fn)
    return sampler, dataloader, num_samples
...
#                 if "blocks.blocks." in name and "norm1" in name and ".weight" in name:
#                     pretrained_norm.append( param )
#                     print( "LR * 0.1: " + name )
#                 elif "blocks.blocks." in name and "norm2" in name and ".weight" in name:
#                     pretrained_norm.append( param )
#                     print( "LR * 0.1: " + name )
#                 elif "blocks.blocks." in name and "norm1" in name and ".bias" in name:
#                     pretrained_norm.append( param )
#                     print( "LR * 0.1: " + name )
#                 elif "blocks.blocks." in name and "norm2" in name and ".bias" in name:
#                     pretrained_norm.append( param )
#                     print( "LR * 0.1: " + name )
#
...
#
#             return [
#                 {'params': pretrained_norm, 'lr': config.optimizer.kwargs.lr * 0.1},
