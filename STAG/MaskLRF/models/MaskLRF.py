...
class LocalPointSetEncoder(nn.Module):   # Embedding module
    def __init__(self, config, encoder_channel):
        ...
        # self.addparam_point_scale = nn.Parameter(torch.ones(1)*2.0)
    ...
    def forward(self, point_groups):
        ...
        # point_groups *= self.addparam_point_scale
        # print( self.addparam_point_scale )
    ...
    def forward( self, x, rel, rel_embedder ):
        ...
        for i, block in enumerate(self.blocks):
            ...
            if( str(i) in self.token_accumulation_modules ):
                ...
                residuals = residuals + self.addparam_downproj_dict[str( module_id )](x.permute(0,2,1))
            ...
            if( str(i) in self.graph_convolution_modules ):
                ...
                center = rel[ :, 0, :, 0:3 ] # 近傍を調べるため，0番目(何番目でもよいが)のLRF上の代表点群を抜き出す
