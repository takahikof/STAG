...
exp_name="exp"
ckpts="../../ckpts/Point-MAE/pretrain.pth"
...
for cfg in "${cfgs[@]}"; do
  CUDA_VISIBLE_DEVICES=$gpuid python main.py --seed $RANDOM --config $cfg --finetune_model --exp_name $exp_name --ckpts $ckpts --stag_size 0
done
