...
class MVPNetDataset(data.Dataset):
    ...
    def __init__(self, config):
        ...
        if( self.subset == "train" ):
            h5_filepath = self.data_root + "/mvpnet_2048pts_withcolor_train.h5"
        elif( self.subset == "test" ):
            h5_filepath = self.data_root + "/mvpnet_2048pts_withcolor_val.h5"
        else:
        ...
        print_log(f'[DATASET] {self.points.shape[0]} instances were loaded', logger = 'MVPNet')
    ...
    def __getitem__(self, idx):
        ...
        return 'MVPNet', 'sample', ( data, class_id )
